...
const PrivacyPolicy = () => {
  document.title = "Privacy Policy | AS Luxury Originals";
  ...
  return (
    <>
      <div className="ref-p">
        ...
        <div>
          <p>
            At ASL ORIGINALS, we are committed to protecting your privacy and
            ...
            protect your data when you visit our website or make a purchase from
            us. By using our website, you agree to the terms outlined in this
            policy.
          </p>
          ...
          <article>
            ...
            <p>
              ...
              Track website performance and optimize our content. <br />
              Analyze user behavior to improve user experience.
            </p>

            <p>
              You can manage your cookie preferences by adjusting your browser
              settings. However, disabling cookies may affect some website
              features, including the shopping cart and checkout process.
            </p>
          </article>
